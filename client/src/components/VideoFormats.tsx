...
const VideoFormats: React.FC<VideoFormatsProps> = ({ data }) => {
    ...
    return (
        <div className="w-content py-2 border-top">
            ...
            <div className="pb-4">
                Some quality formats have 2 options because Youtube generates 2
                video encoding formats. Please click on "preview" before
                downloading a video format to check whether the format is still
                working or cannot be played by normal player.
            </div>
